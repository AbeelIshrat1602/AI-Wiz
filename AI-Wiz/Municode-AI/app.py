...
def get_web_data(selected_state, selected_city):
    search_list = get_lists("Search")
    raw_text = get_txt_file()
    if len(raw_text) != 0:
...
def main():
    ...
    load_dotenv()
    st.set_page_config(page_title="ArchiWiz Bot 🤖", page_icon="\U0001F916")
    ...
    with st.sidebar:
        ...
        if slider == 'Webpage Data':
            ...
            if st.checkbox("Developer Mode"):
                ...
                raw_text = get_web_data(selected_state, selected_city)
